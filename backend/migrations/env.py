...
models to auto-detect for migration generation.

It reads DATABASE_URL from the app's settings so that the connection
string is always consistent with the running application.
"""
